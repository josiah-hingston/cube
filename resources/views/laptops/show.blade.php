	...
	<div class="col-md-6 col-sm-12">
		...
		<div class="list-group">
		  <a href="#" class="list-group-item">
		    ...
		    <p class="list-group-item-text">{{ $laptop->asset }}</p>
		  </a>
		  <a href="#" class="list-group-item">
		    <h4 class="list-group-item-heading">Serial</h4>
		    <p class="list-group-item-text">{{ $laptop->serial }}</p>
		  </a>
		  <a href="#" class="list-group-item">
		    <h4 class="list-group-item-heading">Make</h4>
		    <p class="list-group-item-text">{{ $laptop->make }}</p>
		  </a>
		  <a href="#" class="list-group-item">
		    <h4 class="list-group-item-heading">Model</h4>
		    <p class="list-group-item-text">{{ $laptop->model }}</p>
		  </a>
		  <a href="#" class="list-group-item">
		    <h4 class="list-group-item-heading">Issued date</h4>
		    <p class="list-group-item-text">{{ $laptop->issued_date }}</p>
		  </a>
		  <a href="#" class="list-group-item">
		    <h4 class="list-group-item-heading">Purchased date</h4>
		    <p class="list-group-item-text">{{ $laptop->purchase_date }}</p>
		  </a>
		</div>
